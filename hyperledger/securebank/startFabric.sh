...
CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/securebank/javascript
...
Next, use the SecureBank applications to interact with the deployed SecureBank contract.
The SecureBank applications are available in multiple programming languages.
