...
class ManageRequestsTier2 extends Component {
    ...
    refreshAccountsState = () => {
      // get accounts
      getRequest(`${API_URL}/api/v1/transaction/CriticalTransactions`)
      .then((data) => {
    ...
    onButtonClick = (type, data) => {
      if (type == 'approve') {
        postRequest(`${API_URL}/api/v1/transaction/ApproveMoneyTransferCritical`, {id: data.id})
        .then((res) => {
          this.refreshAccountsState()
        ...
        postRequest(`${API_URL}/api/v1/transaction/DeclineMoneyTransferCritical`, {id: data.id})
        .then((res) => {
          this.refreshAccountsState()
          this.props.history.push('/manageRequests')
...
export default ManageRequestsTier2