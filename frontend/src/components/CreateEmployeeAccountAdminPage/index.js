...
class CreateEmployeeAccountAdminPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      first_name: "",
  ...
  onButtonClick = () => {
    if (this.validate()) {
      ...
      postRequest(`${API_URL}/api/v1/admin/CreateEmployeeAccount`, this.state)
        .then(() => {
  ...
  render() {
    return (
      <div className="create-form-container">
        ...
        >
          <Radio value={3}> Tier 1 Employee </Radio>
          <Radio value={4}> Tier 2 Employee </Radio>
        </Radio.Group>
        <br />
        <br />
        Address: <br />
...
export default CreateEmployeeAccountAdminPage;
